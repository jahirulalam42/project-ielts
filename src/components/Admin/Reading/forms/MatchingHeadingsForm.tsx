...
interface MatchingHeadingsFormProps {
  questions: Question[];
  passageIndex: number;
  groupIndex: number;
  test: ReadingTest;
...
const MatchingHeadingsForm: React.FC<MatchingHeadingsFormProps> = ({
  questions,
  passageIndex,
  groupIndex,
  test,
  ...
  const updateQuestion = (field: string, value: any, qIndex: number) => {
    ...
    updatedParts[passageIndex].questions[groupIndex]["matching_headings"][
      qIndex
...
export default MatchingHeadingsForm; 